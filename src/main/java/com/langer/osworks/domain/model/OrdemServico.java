package com.langer.osworks.domain.model;
...
import com.langer.osworks.domain.IValidationGroup;
...
public class OrdemServico {
	...
	@Valid
	@ConvertGroup(from = Default.class, to = IValidationGroup.ClienteId.class)
	@NotNull
	@ManyToOne
	...
	public void finalizar() {
		if(!StatusOrdemServico.ABERTA.equals(this.getStatus())) {
			throw new NegocioException("OsCantDone");
		}
